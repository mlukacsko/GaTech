...
def plot_indicators():
    ...
    sma = ind.get_simple_moving_average(df_prices, lookback)
    ind.get_bb(sma, normalized_prices, df_prices, lookback)
    ind.get_momentum(df_prices, normalized_prices, lookback)
    ind.get_macd(df_prices, normalized_prices)
    ind.get_volatility(normalized_prices, df_prices, lookback)
