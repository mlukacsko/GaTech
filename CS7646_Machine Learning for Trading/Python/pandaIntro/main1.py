...
def gambling_simulator(win_prob, has_bankroll):
...
def experiment1_figure1(win_prob, has_bankroll):
    for i in range(10):
        winnings = gambling_simulator(win_prob, has_bankroll)
        plt.plot(winnings, label='Episode ' + str(i+1))
    plt.axis((0, 300, -256, 100))
    plt.title("Exp 1 Figure 1: 10 Episodes, Track of Winnings with Unlimited Bankroll")
    plt.xlabel('# of Spins ')
...
def experiment1_figure2(win_prob, has_bankroll):
    fig2_array = np.zeros((1000,1000))
    for j in range(1000):
        current = gambling_simulator(win_prob, has_bankroll)
    ...
    plt.axis((0, 300, -256, 100))
    plt.title("Exp1 Figure 2: 1000 Episodes, Mean of Winnings with Unlimited Bankroll")
    plt.xlabel('# of Spins ')
    plt.ylabel('$ of Winnings')
...
def experiment1_figure3(win_prob, has_bankroll):
...
def experiment2_figure4(win_prob, has_bankroll):
    ...
    mean_minus_std = mean_of_winnings - std_of_winnings
    plt.axis((0, 300, -256, 100))
    plt.title("Exp2 Figure 4: 1000 Episodes, Mean of Winnings with $256 Bankroll")
    plt.xlabel('# of Spins ')
    plt.ylabel('$ of Winnings')
    plt.plot(mean_of_winnings, label="Mean of Winnings")
    plt.plot(mean_plus_std, label="Mean + std")
...
def experiment2_figure5(win_prob, has_bankroll):
...
def test_code():
    ...
    experiment1_figure1(win_prob, has_bankroll=False)
    experiment1_figure2(win_prob, has_bankroll=False)
    experiment1_figure3(win_prob, has_bankroll=False)
    experiment2_figure4(win_prob, has_bankroll=True)
    experiment2_figure5(win_prob, has_bankroll=True)
